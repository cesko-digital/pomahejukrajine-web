...
const faqs = [
	...
	},
	{
		...
		answer: 'Úplně každý, kdo chce pomoci, ať již jako jednotlivec, firma, nebo obec. Prosíme, zadejte svou nabídku do databáze.',
	},
	{
		question: 'Kdo tuto platformu zajišťuje?',
		answer: 'Platformu zajišťuje <a class="underline" href="https://migracnikonsorcium.cz/cs/">Konsorcium nevládních organizací pracujících s migranty v ČR</a>, které sdružuje 15 nevládních organizací zabývajících se dlouhodobě migrací a integrací cizinců. Technologicky ji vyvinula společnost <a class="underline" href="https://www.contember.com/">Contember</a> s podporou dobrovolníků a podporovatelů. Prvotní impuls vznikl z podnětu Jana Böhma a Daniela Kolského.',
	},
	{
	...
	},
	{
		...
		answer: 'Pokud jste odbornice/odborník, nabízíte nějakou seniorní znalost, nebo zkušenost (především psychologie, zdravotnictví, sociální práce, pedagogika dětí, nebo IT apod), prosím <a class="underline" href="/nabidka">dejte nám o tom vědět</a>, budeme vás kontaktovat.',
	},
	{
		question: 'Potřebujete podporu, nebo pomoc?',
		answer: 'Předpokládáme i možnost zadávání konkrétních potřeb, kterou chystáme po spuštění nabídkové části platformy. Nyní máte možnost vyhledávat a filtrovat v rámci zveřejněných nabídek pomoci. Prosíme, nejdříve zkuste před psaním vlastní poptávky projít existující nabídky.',
	},
	{
		question: 'Jak to technicky funguje?',
		answer: 'Po vyplnění jednoduchého dotazníku proběhne ověření vašeho emailu. V případě složitějších a rozsáhlejších nabídek vás budeme co nejdříve kontaktovat. ',
	},
	{
		question: 'Chcete pomoci raději finančně?',
		answer: 'To je skvělé a velice děkujeme za každou podporu. Seznam ověřených sbírek pomoci soustřeďuje projekt <a class="underline" href="https://www.stojimezaukrajinou.cz/">Stojíme za Ukrajinou</a> <a class="underline" href="https://cesko.digital/">Česko.digital</a>, případně můžete podpořit jakoukoliv ze sbírek organizací, které jsou členy Konsorcia. Děkujeme a vážíme si vaší podpory. ',
	},
	{
		question: 'Děláme něco podobného jako dělá platforma Pomáhej Ukrajině, co teď?',
		answer: 'To je skvělá a oceňujeme každou smysluplnou pomoc. Prosíme, pokud jste již nějakým způsobem organizováni, nebo jste jinou platformou (například ve škole, oddíle, v práci apod), dejte nám o sobě vědět, ať můžeme třeba spolupracovat.',
	},
	{
		question: 'Všechny zveřejněné nabídky poskytuje Konsorcium?',
		answer: 'Ne, tato platforma není přehledem toho, co poskytujeme my, nebo naši členové. Platforma se snaží soustředit co nejvíce kapacit na jednom místě. Snaží se s touto kapacitou také co nejlépe a efektivně pracovat. Konsorcium shromažďuje nabídky pomoci a umožňuje jednotlivcům a organizacím, aby na ně reagovali.',
	},
	{
		question: 'Kontrolujete nějak kvality nabízených služeb?',
		answer: 'Budeme se snažit dlouhodobě ověřovat nabídky, koordinovat jejich další využití i podporovat naše klientky a klienty.  Vždy se řídíme zájmem příchozích a snažíme se pro ně zajistit důstojné podmínky. Také proto nejsou některé nabídky přímo zveřejněny na webu, ale projdou nejprve ověřením a propojením pomáhajících a těch, kdo pomoc potřebují. Zapojené nevládní organizace nemohou přejímat odpovědnost za všechny nabídky ani za poptávku, ale pokusí se obě strany dobře informovat a propojit obě strany tak, aby pomoc byla co nejúčinnější. V případě zveřejněných nabídek, na které mohou reagovat přímo ti, kteří pomoc potřebuji, ale nemáme možnost kvalitu nabízených služeb kontrolovat.',
	},
	{
		question: 'Jste novinář a chcete více informací?',
		answer: 'Ozvěte se nám na <a class="underline" href="mailto:krchova@migracnikonsorcium.cz">krchova@migracnikonsorcium.cz</a>, rádi vám je poskytneme.',
	}
]
		...
		<div className="antialiased text-gray-600">
			...
			<div className="bg-white">
				<div className="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:py-20 lg:px-8">
					<div>
						<h1 className="text-center text-4xl font-extrabold text-gray-900">Často kladené otázky</h1>
					</div>
					<div className="mt-12">
						<dl className="space-y-12">
						{faqs.map((faq) => (
							<div key={faq.question}>
							<dt className="text-lg leading-6 font-bold text-gray-900">{faq.question}</dt>
							<dd className="mt-2 text-base text-gray-700" dangerouslySetInnerHTML={{ __html: faq.answer }}></dd>
							</div>
						))}
						</dl>
					</div>
