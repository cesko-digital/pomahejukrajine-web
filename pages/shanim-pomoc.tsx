				...
				<div className="relative max-w-xl mx-auto">
					<main className="mt-2">
						<div className="text-center">
							<h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Sháním pomoc</h2>
						</div>
						<div className={`mt-12 ${process.env.NEXT_TEMPORARY == 'TEMPORARY' ? 'hidden' : ''}`}>
							<HelpForm offerTypes={offerTypes} uk={false} districts={districts} languages={languages} />
						</div>
					</main>
				</div>
			</div>
