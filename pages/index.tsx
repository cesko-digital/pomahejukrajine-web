...
const Home: NextPage = () => (
	<div className="pt-12 md:pt-[320px] flex flex-col md:flex-row p-4 md:p-0">
		<div className="w-full md:w-2/5 flex justify-center">
			<div className="md:max-w-xs">
				<Image
					src="/pomahej-ukrajine.png"
					alt="pomahej ukrajine"
					width={1300}
					height={190}
				/>
			</div>
		...
		<div className="text-black text-3xl font-bold">
			<div className="w-full md:w-3/5">
				<p>
					Probíhá údržba systému. Není možné nyní platformu Pomáhej Ukrajině
					využívat.
				</p>
				<br />
				<p>
					Ведеться обслуговування системи. Зараз неможливо платформу Допомагай
					Україні використати.
				</p>
			</div>
		</div>
