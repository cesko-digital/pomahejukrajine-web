			...
			<div className="md:container md:mx-auto">
				...
				<div className="flex justify-center mb-[45px] md:mb-[91px]">
					<Link href="#offerAccommodation">
						<a className="text-white text-[18px] text-center bg-ua-blue font-bold rounded-md w-[225px] p-4 mt-4 md:mt-9 flex justify-center items-center hover:bg-ua-blue-dark transition duration-150">
